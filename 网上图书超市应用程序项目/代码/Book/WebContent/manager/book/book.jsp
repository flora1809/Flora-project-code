...
<HTML>
	<HEAD>
	 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/public/js/book.js"></script>
		<%
												...
												<TR>
															...
															<TBODY>
																...
																<TR>
																	<TD class=word_grey vAlign=top colSpan=2 height=112>
																		<UL>
																			<LI>
																				添加图书信息：点击“添加图书信息”超链接可以进行图书信息的添加。
																			<LI>
																				修改图书信息：点击每条图书信息后面的“修改”按钮可以修改图书信息。
																			<LI>
													...
													<TD vAlign=top width="73%">
															...
															<TBODY>
																<TR>
																	<TD align=left height=13>&nbsp;
																		<a href="javascript:void(0)" onclick='addbook()'>+添加图书信息+</a>
																	</TD>
																</TR>
															</TBODY>
														</TABLE>
														<TABLE borderColor=#ffffff height=48 cellSpacing=0
															...
															<TBODY>
																<TR>
																	<TD align=middle width="20%" height=27>
																		书号
																	</TD>
																...
																<TR
																	...
																	<TD align=middle>
																		<a href="javascript:void(0)" onclick='bookdetail(<%=book.getBid()%>)'><%=book.getBname()%></A>
																	</TD>
																	<TD align=middle>
																		<%=book.getPublish()%>
																	</TD>
																	...
																	<TD align=middle>
																		<A href="javascript:void(0)" onclick='altbook(<%=book.getBid()%>)'><IMG height=15 src="${pageContext.request.contextPath}/public/images/modify.gif"
																				width=15> </A>
																	</TD>
																	<TD align=middle>
																		<A href="javascript:void(0)" onclick='delbook(<%=book.getBid()%>,"<%=book.getBname()%>")'><IMG height=16 src="${pageContext.request.contextPath}/public/images/del.gif"
																				width=16> </A>
																	</TD>
																</TR>
																<%
